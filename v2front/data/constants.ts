...
export const STEP_CONFIG: Record<string, StepCopy> = {
  ...
  stress: {
    ...
    meaning: {
      q: 'Яг тэр мөчид чи дотроо юуг “байгаа шиг нь байгаасай” гэж хамгийн их хүсдэг вэ?',
      placeholder: 'бүх зүйл нурчихгүй байх итгэл, амсхийх зай, бүхнийг хянахгүй байсан ч зүгээр байх мэдрэмж...',
    },
  },
  ...
  loneliness: {
    ...
    meaning: {
      q: 'Яг үнэндээ чамд “би ганцаараа биш” гэж мэдрэгдэх тэр мөч ямар байх вэ?',
