...
const TableNameGoalMilestones = "goal_milestones"

// GoalMilestones mapped from table <goal_milestones>
type GoalMilestones struct {
	ID          uint      `gorm:"column:id;type:integer;primaryKey;autoIncrement:true" json:"id"`
	GoalID      uint      `gorm:"column:goal_id;type:integer;not null" json:"goal_id"`
