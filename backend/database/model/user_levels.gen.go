...
const TableNameUserLevels = "user_levels"

// UserLevels mapped from table <user_levels>
type UserLevels struct {
	...
	MaxScore    int       `gorm:"column:max_score;type:integer;not null" json:"max_score"`
	...
	Perks       string    `gorm:"column:perks;type:text" json:"perks"`
