...
func newAIScoringCriteria(db *gorm.DB, opts ...gen.DOOption) aIScoringCriteria {
	...
	_aIScoringCriteria.ID = field.NewInt(tableName, "id")
	_aIScoringCriteria.CriteriaName = field.NewString(tableName, "criteria_name")
	_aIScoringCriteria.CriteriaCategory = field.NewString(tableName, "criteria_category")
	...
	_aIScoringCriteria.CalculationMethod = field.NewString(tableName, "calculation_method")
	...
	_aIScoringCriteria.UpdatedAt = field.NewTime(tableName, "updated_at")
...
func (a *aIScoringCriteria) updateTableName(table string) *aIScoringCriteria {
	...
	a.CriteriaCategory = field.NewString(table, "criteria_category")
	a.Description = field.NewString(table, "description")
	a.MaxPoints = field.NewInt(table, "max_points")
	a.Weight = field.NewFloat64(table, "weight")
	a.CalculationMethod = field.NewString(table, "calculation_method")
...
func (a *aIScoringCriteria) fillFieldMap() {
	...
	a.fieldMap["criteria_category"] = a.CriteriaCategory
	a.fieldMap["description"] = a.Description
	a.fieldMap["max_points"] = a.MaxPoints
	a.fieldMap["weight"] = a.Weight
	a.fieldMap["calculation_method"] = a.CalculationMethod
