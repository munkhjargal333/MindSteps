...
func newGoalMilestones(db *gorm.DB, opts ...gen.DOOption) goalMilestones {
	...
	_goalMilestones.SortOrder = field.NewInt(tableName, "sort_order")
	...
	_goalMilestones.Goal = goalMilestonesBelongsToGoal{
		...
		Value: struct {
			...
			MaslowLevel: struct {
				...
				RelationField: field.NewRelation("Goal.Value.MaslowLevel", "model.MaslowLevels"),
			},
		},
	}
...
func (g *goalMilestones) updateTableName(table string) *goalMilestones {
	...
	g.SortOrder = field.NewInt(table, "sort_order")
