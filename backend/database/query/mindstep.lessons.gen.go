...
func newLessons(db *gorm.DB, opts ...gen.DOOption) lessons {
	...
	_lessons.CategoryID = field.NewInt(tableName, "category_id")
	...
	_lessons.RelatedValueKeywords = field.NewString(tableName, "related_value_keywords")
	_lessons.RelatedEmotionKeywords = field.NewString(tableName, "related_emotion_keywords")
	...
	_lessons.LikeCount = field.NewInt(tableName, "like_count")
	...
	_lessons.SortID = field.NewInt32(tableName, "sort_id")
...
type lessons struct {
	...
	Tags                   field.String
	RelatedValueKeywords   field.String
	RelatedEmotionKeywords field.String
...
func (l *lessons) updateTableName(table string) *lessons {
	...
	l.CategoryID = field.NewInt(table, "category_id")
	...
	l.RelatedValueKeywords = field.NewString(table, "related_value_keywords")
	l.RelatedEmotionKeywords = field.NewString(table, "related_emotion_keywords")
