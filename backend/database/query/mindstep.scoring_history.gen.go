...
func newScoringHistory(db *gorm.DB, opts ...gen.DOOption) scoringHistory {
	...
	_scoringHistory.UserID = field.NewString(tableName, "user_id")
	_scoringHistory.SourceType = field.NewString(tableName, "source_type")
	_scoringHistory.SourceID = field.NewUint(tableName, "source_id")
	...
	_scoringHistory.Multiplier = field.NewFloat64(tableName, "multiplier")
...
func (s *scoringHistory) updateTableName(table string) *scoringHistory {
	...
	s.Multiplier = field.NewFloat64(table, "multiplier")
...
func (s *scoringHistory) fillFieldMap() {
	...
	s.fieldMap["multiplier"] = s.Multiplier
