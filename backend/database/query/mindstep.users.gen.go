...
func newUsers(db *gorm.DB, opts ...gen.DOOption) users {
	...
	_users.TotalScore = field.NewInt32(tableName, "total_score")
	_users.CurrentLevel = field.NewInt32(tableName, "current_level")
...
type users struct {
	...
	ID             field.String
	Name           field.String
	TotalScore     field.Int32
	CurrentLevel   field.Int32
...
func (u *users) updateTableName(table string) *users {
	...
	u.TotalScore = field.NewInt32(table, "total_score")
	u.CurrentLevel = field.NewInt32(table, "current_level")
