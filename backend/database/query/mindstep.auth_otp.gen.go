...
func newAuthOTP(db *gorm.DB, opts ...gen.DOOption) authOTP {
	...
	_authOTP.OtpCode = field.NewString(tableName, "otp_code")
	_authOTP.OtpType = field.NewString(tableName, "otp_type")
	_authOTP.IsUsed = field.NewBool(tableName, "is_used")
...
type authOTP struct {
	...
	ID        field.Uint
	UserID    field.Uint
	OtpCode   field.String
	OtpType   field.String
	IsUsed    field.Bool
...
func (a *authOTP) updateTableName(table string) *authOTP {
	...
	a.OtpCode = field.NewString(table, "otp_code")
	a.OtpType = field.NewString(table, "otp_type")
	a.IsUsed = field.NewBool(table, "is_used")
