...
func newAIProgressTracking(db *gorm.DB, opts ...gen.DOOption) aIProgressTracking {
	...
	_aIProgressTracking.ConsciousnessLevelChange = field.NewInt(tableName, "consciousness_level_change")
	_aIProgressTracking.KeyImprovements = field.NewField(tableName, "key_improvements")
	_aIProgressTracking.AreasNeedingAttention = field.NewField(tableName, "areas_needing_attention")
	_aIProgressTracking.BehavioralChangesDetected = field.NewField(tableName, "behavioral_changes_detected")
...
type aIProgressTracking struct {
	...
	ConsciousnessLevelChange  field.Int
	KeyImprovements           field.Field
	AreasNeedingAttention     field.Field
	BehavioralChangesDetected field.Field
...
func (a *aIProgressTracking) updateTableName(table string) *aIProgressTracking {
	...
	a.ConsciousnessLevelChange = field.NewInt(table, "consciousness_level_change")
	a.KeyImprovements = field.NewField(table, "key_improvements")
	a.AreasNeedingAttention = field.NewField(table, "areas_needing_attention")
	a.BehavioralChangesDetected = field.NewField(table, "behavioral_changes_detected")
...
func (a *aIProgressTracking) fillFieldMap() {
	...
	a.fieldMap["consciousness_level_change"] = a.ConsciousnessLevelChange
